					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" method="post" action="post-data.php">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" minlength="6" maxlength="12" id="create_user_name" name="create_user_name" placeholder="User Name">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="password" class="form-control" minlength="8" maxlength="16" id="create_password" name="create_password" placeholder="Password">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="password" class="form-control" minlength="8" maxlength="16" id="confirm_password" name="confirm_password" placeholder="Confirm Password">
								</div>
